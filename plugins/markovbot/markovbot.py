	...
	def generate_text(self, maxlength, seedword=None, database=u'default',
		...
		while error:
			...
			try:
				...
				initial_words = self.data[database]
				...
				if seedword != None:
					...
					while len(seedword) > 0:
						...
						for i in range(len(word_list)):
							...
							if seedword[0] in word_list[i] or \
